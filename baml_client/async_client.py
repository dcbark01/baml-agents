...
class BamlAsyncClient:
    ...
    async def UseCalculator(
        self,
        goal: str,
        baml_options: BamlCallOptions = {},
    ) -> types.CalculatorUsage:
      ...
      return cast(types.CalculatorUsage, raw.cast_to(types, types, partial_types, False))
...
class BamlStreamClient:
    ...
    def UseCalculator(
        ...
        goal: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.CalculatorUsage, types.CalculatorUsage]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.CalculatorUsage, types.CalculatorUsage](
        raw,
        lambda x: cast(partial_types.CalculatorUsage, x.cast_to(types, types, partial_types, True)),
        lambda x: cast(types.CalculatorUsage, x.cast_to(types, types, partial_types, False)),
        self.__ctx_manager.get(),
      )
